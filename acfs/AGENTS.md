...
| `agy` | Antigravity CLI (Google) - start interactive session (successor to the retired Gemini CLI; `gmi` is kept as an alias for it; pinned to "Gemini 3.7 Flash (High)") |
