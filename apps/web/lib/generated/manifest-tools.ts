...
export const manifestTools: ManifestWebTool[] = [
  ...
  },
  {
    ...
    shortDesc: "Durable, local-first, explainable memory for coding agents (ee)",
    icon: "brain",
    color: "#8B5CF6",
    ...
    useCases: [
      "Priming a cold agent session with relevant project memory",
      "Capturing and reusing hard-won project rules",
    ...
    cliName: "ee",
    cliAliases: [],
    commandExample: "ee pack \"fix the auth bug\"",
    lessonSlug: "ee",
  },
  {
    ...
    shortDesc: "Pure-Rust Markdown engine rendering self-contained HTML and tagged PDF (fmd)",
    icon: "file-text",
    color: "#F59E0B",
    ...
    cliName: "fmd",
    cliAliases: [],
    commandExample: "fmd README.md --out README.html",
    lessonSlug: "fmd",
  },
  {
  ...
  },
  {
    ...
    shortDesc: "Native single-binary Rust port of the Pi coding agent (pi)",
    icon: "bot",
    color: "#06B6D4",
    ...
    useCases: [
      "Running a coding agent against local models without API keys",
      "Single-shot scripted agent runs in pipelines",
      "Long sessions with bounded-resource storage and fast resume",
    ],
    language: "Rust",
    stars: 45,
    cliName: "pi",
    cliAliases: [],
    commandExample: "pi \"refactor this function\"",
    lessonSlug: "pi",
  },
  {
    ...
    shortDesc: "Recover crashed coding-agent sessions after a hard power cut (pfr)",
    icon: "power",
    color: "#EF4444",
    ...
    useCases: [
      ...
      "Selectively restoring a subset of sessions from a saved plan",
