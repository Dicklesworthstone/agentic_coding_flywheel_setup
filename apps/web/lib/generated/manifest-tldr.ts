...
export const manifestTldrTools: ManifestTldrTool[] = [
  ...
  },
  {
    ...
    tldrSnippet: "Durable, local-first, explainable memory for coding agents (ee)",
    icon: "brain",
    color: "#8B5CF6",
  ...
  },
  {
    ...
    tldrSnippet: "Pure-Rust Markdown engine rendering self-contained HTML and tagged PDF (fmd)",
    icon: "file-text",
    color: "#F59E0B",
  ...
  },
  {
    ...
    tldrSnippet: "Native single-binary Rust port of the Pi coding agent (pi)",
    icon: "bot",
    color: "#06B6D4",
  ...
  },
  {
    ...
    tldrSnippet: "Recover crashed coding-agent sessions after a hard power cut (pfr)",
    icon: "power",
    color: "#EF4444",
