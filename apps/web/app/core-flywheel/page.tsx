import { ArrowRight, Bug, ChevronDown, Rocket, Search, Shield, Sparkles } from "lucide-react";
  ...
  return (
    <ErrorBoundary>
      <main
        id="main-content"
        tabIndex={-1}
        className="text-aa-floor min-h-screen bg-[#020408] selection:bg-[#FF5500]/20 selection:text-white overflow-x-clip pb-40"
      >
        <Hero />
        ...
        <div className="mx-auto max-w-[1000px] px-6 lg:px-12 relative mt-20">
          ...
          <GuideSection id="why" number="1" title="Why a Simpler Starting Point">
            <P highlight>
              The full Flywheel system has grown large enough that many people find it overwhelming
              on first contact. That reaction makes sense. But there is a much smaller core that
              already captures most of what makes the approach powerful.
            </P>

            <P>
              The larger system includes planning workflows, memory systems, prompt libraries,
              launch tooling, safety tooling, skills, and a lot of accumulated operational detail.
              You do not need to absorb all of that up front.
            </P>

            <P>
              The core loop uses just <Hl>three tools</Hl>. If you understand those three and use
              them together correctly, you already have the heart of the system.
            </P>
            ...
            <P>
              Separate the process into two layers: the <Hl>planning substrate</Hl> (frontier models
              used to create and refine the markdown plan) and the <Hl>core operating loop</Hl>{" "}
              (Agent Mail, br, and bv once the plan is ready to drive execution).
            </P>

            <SubSection title="Who This Is For">
              <P>
                This document is for a relatively smart software developer who is new to agentic
                coding and does not want to absorb the entire larger Flywheel guide up front. The
                goal is narrower: get you to the point where you can coordinate multiple agents
                without chaos, keep work organized as explicit tasks with dependencies, and keep
                agents working on the best next unblocked task instead of choosing randomly.
              </P>
              <P>
                If that works well for you, the larger Flywheel stack becomes much easier to
                appreciate later.
              </P>
            </SubSection>

            <TipBox variant="info">
              When this guide says &quot;three-tool core,&quot; it means the durable execution
              substrate you keep live while the project is being carried out. It does not mean the
              planning phase happens in a vacuum. The first step is still creating an excellent
              markdown plan.
            </TipBox>
          </GuideSection>
          ...
          <GuideSection id="terms" number="2" title="Five Terms You Need">
            <P>
              If these five terms stay clear in your head, most of the rest of the guide gets much
              easier to follow.
            </P>
            ...
            <SubSection title="How the Tools Work Together (Behind the Scenes)">
              <P>
                ...
                <code>AGENTS.md</code> file is set up correctly, the agents handle the integration
                automatically: they use bead IDs as thread identifiers in Agent Mail, they announce
                claims and reserve files before editing, and they update bead status as they work.
                You configure this once in AGENTS.md and then the agents just do it.
              </P>
              <TipBox variant="info">
                The human&apos;s job is to write a good plan, create good beads, launch agents with
                the right marching orders, and then tend the swarm. The agents handle the
                coordination plumbing themselves.
              </TipBox>
            </SubSection>
          </GuideSection>
          ...
          <GuideSection id="core-loop" number="3" title="The Core Loop">
            <P highlight>
              The core loop is simple: generate a plan, encode it as beads, launch agents with
              marching orders, let them coordinate through Agent Mail while bv routes them toward
              the best next bead, and tend the swarm until the graph is done.
            </P>
            ...
            <P>
              The core loop moves work out of ephemeral chat and into explicit, inspectable
              artifacts. That is the short answer to &quot;why bother?&quot;
            </P>
          ...
          <GuideSection id="three-tools" number="4" title="The Three Tools Are a Single Machine">
            <P>
              These three tools solve three different failure modes. Each helps on its own, but the
              value shows up most clearly when they form a stable loop together.
            </P>

            <SubSection title="Agent Mail Solves Coordination">
              <P>
                Without Agent Mail, multiple agents constantly collide: two agents edit the same
                files, nobody knows who is doing what, messages disappear into chat history, and
                work gets stranded when an agent crashes.
              </P>
              <P>
                Agent Mail gives agents a shared coordination layer with <Hl>identities</Hl>,{" "}
                <Hl>threads</Hl>, <Hl>inboxes</Hl>, and <Hl>file reservations</Hl>. Agents announce
                what they are doing, reserve edit surfaces, and recover when another agent
                disappears. All of this happens automatically once your AGENTS.md tells agents to
                use Agent Mail.
              </P>
            </SubSection>
            ...
            <SubSection title="br Solves Task Structure">
              <P>
                Without br, work collapses into vague conversational intentions: &quot;fix the auth
                stuff,&quot; &quot;clean up the admin area,&quot; &quot;someone should improve
                tests.&quot; That kind of tasking is too fuzzy for a swarm.
              </P>
              <P>
                <code>br</code> turns work into explicit beads with <Hl>status</Hl>,{" "}
                <Hl>priority</Hl>, and <Hl>dependencies</Hl>. Once work is represented that way,
                multiple agents can make progress without constant human steering.
              </P>
            </SubSection>

            <SubSection title="bv Solves Routing">
              <P>
                Even with good beads, agents still need to know what to do next. Without bv, they
                choose work based on local convenience or whatever they most recently saw in
                context.
              </P>
              <P>
                <code>bv</code> reads the bead graph and computes what is most worth doing next.
                That turns the swarm from &quot;many agents doing work&quot; into &quot;many agents{" "}
                <Hl>pushing the project forward efficiently</Hl>.&quot;
              </P>
            </SubSection>
          ...
          <GuideSection id="artifact-ladder" number="5" title="The Artifact Ladder">
            <P>
              One reason agentic coding feels confusing at first is that the{" "}
              <Hl>active artifact keeps changing</Hl>. The easiest way to stay oriented is to know
              what the current artifact means and what you do with it next.
            </P>
            ...
            <SubSection title="Plan Space, Bead Space, and Code Space">
              <P>
                <strong>Plan space</strong> is where you decide the workflows, constraints,
                architecture, and testing expectations. <strong>Bead space</strong> is where you
                transform that thinking into executable memory for agents.{" "}
                <strong>Code space</strong> is where agents implement the local task that a bead
                defines.
              </P>
              <P>
                The general rule is simple. Debates belong in plan space. Translation and dependency
                shaping belong in bead space. Implementation belongs in code space.
              </P>
              <TipBox variant="warning">
                If the swarm starts discovering missing structure while coding, the answer is often
                to step back up into bead space or plan space instead of forcing more code through a
                weak task graph.
              </TipBox>
            </SubSection>
            ...
            <SubSection title="What a Good Plan Looks Like">
              <P>
                A strong plan lets a fresh reader answer five questions without guessing: what are
                the main workflows? What constraints matter? What architecture are we choosing? How
                will we know it works? What failure cases must not disappear into hand-waving?
              </P>
              <CodeBlock
                language="markdown"
...
- E2E coverage for upload, failed-ingestion review, retry, search, and filtering.`}
              />
              <P>
                It gives a fresh agent workflows, constraints, architecture, testing, and failure
                handling in one place. Before you turn the plan into beads, check that these five
                questions are answerable from the plan alone.
              </P>
            </SubSection>

            <SubSection title="Escalation Ladder">
              <P>
                When something feels wrong, use the smallest escalation that actually fits the
                problem:
              </P>
              <BulletList
                items={[
                  ...
                  <Fragment key="bead">
                    <strong>Weak or underspecified bead</strong> — step back into bead space and
                    rewrite the bead
                  </Fragment>,
                  <Fragment key="graph">
                  ...
                  <Fragment key="plan">
                    <strong>Missing plan work</strong> — step back into plan space and revise the
                    markdown plan
                  </Fragment>,
                  <Fragment key="agent">
          ...
          <GuideSection id="example" number="6" title="A Concrete Example: Atlas Notes">
            <P>
              A small project makes the workflow easier to picture. Imagine building an internal
              tool called <strong>Atlas Notes</strong>: team members upload Markdown notes, the
              system tags and indexes them, users can search them quickly, and admins can inspect
              failed ingestions.
            </P>

            <P>
              If you gave four agents only that vague description, they would step on each other and
              make mismatched assumptions. The core loop instead looks like this:
            </P>
            ...
            <SubSection title="What a Good Bead Looks Like">
              <P>
                The bead is the unit of work agents actually execute. Weak beads force
                improvisation. Rich beads make execution mechanical. Here is a real bead from the
                ACFS project:
              </P>
              <CodeBlock
                language="markdown"
                code={`bd-01s: Add --deep flag to acfs doctor
...
- scripts/lib/doctor.sh: Argument parsing`}
              />
              <P>
                The prose does not need polish. A fresh agent should be able to understand the task,
                the reason for it, and the acceptance criteria without reopening the whole markdown
                plan. You can browse real beads from actual Flywheel projects at{" "}
                <a
                  href="https://dicklesworthstone.github.io/beads_for_franken_engine"
                  target="_blank"
                ...
                ,{" "}
                <a
                  href="https://dicklesworthstone.github.io/beads-for-frankentui/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#FF5500] hover:text-[#FFBD2E] underline underline-offset-4 decoration-[#FF5500]/30 hover:decoration-[#FFBD2E]/50 transition-colors"
                >
                ...
                , and{" "}
                <a
                  href="https://dicklesworthstone.github.io/beads_for_asupersync"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#FF5500] hover:text-[#FFBD2E] underline underline-offset-4 decoration-[#FF5500]/30 hover:decoration-[#FFBD2E]/50 transition-colors"
                >
            ...
            <SubSection title="Weak vs. Strong Artifacts">
              <P>
                Quality thresholds get easier to feel when you compare weak and strong versions
                directly. The weak version names a topic. The strong version scopes the actual
                requirement, constraint, and testing obligation.
              </P>
              <BeadComparisonViz />
            </SubSection>
            ...
            <SubSection title="What the Agents Do Automatically">
              <P>
                Once you launch agents with good marching orders, they automatically handle the
                coordination mechanics. A typical bead thread in Agent Mail looks like this —
                created entirely by agents, not by you:
              </P>

              <CodeBlock
                language="text"
                code={`[br-103] Start: Failed-ingestion admin screen
...
Auth checks in place. E2E coverage for malformed upload → admin review → retry.`}
              />
              <P>
                You do not write these messages. The agents create them because your AGENTS.md tells
                them to coordinate through Agent Mail and use bead IDs as thread anchors. Your job
                is to monitor these threads to see if work is flowing or stuck.
              </P>
            </SubSection>
          </GuideSection>
          ...
          <GuideSection id="operating-rhythm" number="7" title="The Operating Rhythm">
            <P highlight>
              This section describes what <strong>you, the human</strong>, actually do. The agents
              handle the coordination plumbing (Agent Mail messages, file reservations, bead status
              updates). Your job is to create the conditions for them to succeed.
            </P>
            ...
            <SubSection title="Step 1: Create an Excellent Markdown Plan">
              <P>
                Before beads or swarms or file reservations, create a serious markdown plan. Do not
                settle for one quick draft from one model.
              </P>
...
[Paste all plans here]`}
              ...
              <P>
                At minimum, you want: the user-facing workflows, the important constraints, the
                major architectural decisions, and the testing expectations.
              </P>
            </SubSection>

            <SubSection title="Step 2: Tell an Agent to Convert the Plan into Beads">
              <P>
                You do not need to manually create every bead yourself. Tell a coding agent to do
                the conversion:
              </P>
              ...
              <P>
                Then polish the beads 4-6 times with fresh review passes. Each round catches things
                the previous round missed. This is the &quot;measure twice, cut once&quot; of the
                methodology.
              </P>

              <TipBox>
                <strong>Beads are executable memory.</strong> The markdown plan is the best artifact
                for whole-system thought. Beads are the plan after it has been transformed into a
                format optimized for distributed execution. Weak beads force improvisation. Rich
                beads make execution mechanical.
              </TipBox>
            </SubSection>

            <SubSection title="Step 3: Launch Agents with Marching Orders">
              <P>
                Once beads are polished and your AGENTS.md is solid, start up a swarm of agents.
                Give each one these marching orders:
              </P>
...
When you're not sure what to do next, use the bv tool mentioned in AGENTS.md to prioritize the best beads to work on next; pick the next one that you can usefully work on and get started. Use ultrathink.`}
              ...
              <P>
                Stagger agent starts by at least 30 seconds to avoid the &quot;thundering herd&quot;
                problem where all agents grab the same bead. Start smaller than your ego wants to: 1
                agent to learn, 2 to feel coordination, 4 for real swarm behavior.
              </P>
            </SubSection>
            ...
            <SubSection title="Step 4: Tend the Swarm">
              ...
              <NumberedList
                items={[
                  <Fragment key="triage">
                    Run <code>bv --robot-triage</code> and check whether the top recommendation
                    still makes sense.
                  </Fragment>,
                  ...
                  <Fragment key="reread">
                    If an agent seems confused after compaction, send: &quot;Reread AGENTS.md so
              ...
              <P>
                That is usually enough to keep the loop healthy without turning the human into a
            ...
            <SubSection title="Step 5: Review, Close, Repeat">
              ...
              <P>
                Then they move to the next bead using bv to find the most impactful one. The cycle
                repeats until the graph is done.
              </P>
            </SubSection>
          </GuideSection>
          ...
          <GuideSection id="operator" number="8" title="The Human&apos;s Job">
            <P highlight>
              The human is not supposed to micromanage every code edit or manually coordinate Agent
              Mail threads. The human is there to keep the structure clean enough that the agents
              can work effectively inside it.
            </P>
            ...
            <SubSection title="What You Do">
              <BulletList
                items={[
                  <Fragment key="plan">
                    <strong>Create the plan and beads</strong> — this is where most of your time and
                    thinking goes
                  </Fragment>,
                  <Fragment key="agents-md">
                    <strong>Write a good AGENTS.md</strong> — this is the operating manual that
                    makes everything else work
                  </Fragment>,
                  <Fragment key="launch">
                    <strong>Launch agents with marching orders</strong> — the same generic prompt
                    every time
                  </Fragment>,
                  <Fragment key="graph">
                    <strong>Keep the bead graph honest</strong> — notice when a missing task or
                    dependency must be added
                  </Fragment>,
                  <Fragment key="restart">
                    <strong>Restart or redirect agents</strong> when they drift, get loopy, or lose
                    context
                  </Fragment>,
            ...
            <SubSection title="What the Agents Do (Not You)">
              ...
              />
              <P>
                All of this is configured once in your AGENTS.md. You do not need to manually invoke
                Agent Mail calls, update bead statuses, or thread bead IDs into messages. The agents
                do it because the operating manual tells them to.
              </P>
            </SubSection>

            <SubSection title="The Reality Check">
              <P>
                When the swarm looks active but you suspect it is not actually closing the real gap,
                stop and ask:
              </P>
              <BlockQuote>
              ...
              <P>
                If the answer is &quot;no,&quot; the fix is usually not more implementation effort.
                Revise the bead graph, add missing work, or step back into planning.
              </P>
            </SubSection>

            <SubSection title="Minimum Viable AGENTS.md">
              <P>
                Even in the smaller core-loop version, you still need a minimal{" "}
                <code>AGENTS.md</code>. It does not have to be a giant doctrine document, but it
                should say:
              </P>
              <BulletList
                items={[
              ...
              />
              <BlockQuote>
                Treat AGENTS.md as the swarm&apos;s durable operating manual. It tells a fresh or
                partially confused agent how to behave, what tools exist, and what &quot;doing a
                good job&quot; looks like in this repo.
              </BlockQuote>

              <TipBox variant="warning">
                <strong>After compaction, agents must re-read AGENTS.md.</strong> If an agent still
                seems confused or loopy after rereading it, stop trying to rescue the degraded state
          ...
          <GuideSection id="failure-modes" number="9" title="Common Failure Modes">
            ...
            <SubSection title="Agent Disappeared Mid-Bead">
              ...
              />
              <TipBox variant="info">
                If recovery feels hard, the bead or the AGENTS.md was probably too thin. That is a
                signal to write richer beads and a more thorough operating manual.
              </TipBox>
            </SubSection>
          </GuideSection>
          ...
          <GuideSection
            ...
            number="10"
            title="What It Feels Like Once It Clicks"
          >
            <P>
              At some point, the workflow stops feeling like extra ceremony and starts feeling like
              a <Hl>calmer control surface</Hl>:
            </P>

            <BulletList
              items={[
                <Fragment key="dup">
                  <strong>Less duplicated work</strong>, because agents manage ownership and
                  reservations automatically
                </Fragment>,
                <Fragment key="drift">
                  <strong>Less &quot;what should I do next?&quot; drift</strong>, because bv keeps
                  answering that question for the agents
                </Fragment>,
                <Fragment key="restart">
                  <strong>Easier restart after context loss</strong>, because the work lives in
                  beads and threads instead of only in chat history
                </Fragment>,
                <Fragment key="handoff">
                  <strong>Easier handoff</strong>, because any agent can read the bead, read the
                  thread, and continue
                </Fragment>,
              ]}
            />
            ...
            <P>
              That operator feeling is a good sign. It usually means the artifacts are carrying the
              work instead of your short-term memory.
            </P>

            <SubSection title="Why This Captures Most of the Value">
              <P>
                People often assume the magic of the Flywheel comes from the total number of tools.
                It does not. Most of the value comes from three things:
              </P>
              <NumberedList
                items={[
              ...
              />
              <P>
                Those three properties are already present in the core loop. That is why the smaller
                system gets you surprisingly far.
              </P>
            </SubSection>

            <SubSection title="When Not to Use the Core Loop">
              <P>
                You probably do not need it for a tiny one-file change with no real dependency
                structure, a purely local experiment, or a quick one-agent cleanup that does not
                need externalized coordination.
              </P>
              <P>
                The loop earns its keep when work has enough structure, enough ambiguity, or enough
                parallelism that explicit planning, explicit tasks, and explicit coordination start
          ...
          <GuideSection id="helpers" number="11" title="Helper Utilities: DCG, UBS & CASS">
            <P>
              Once the core loop is running smoothly, three helper utilities significantly improve
              safety, quality, and learning. They are <Hl>multipliers on top of the core loop</Hl>,
              not prerequisites.
            </P>
            ...
            <SubSection title="What You Can Ignore for Now">
              ...
              />
              <P>
                Those things help. Some help a lot. But they are multipliers on top of the core
                loop, not prerequisites. You can run the core loop with separate terminal tabs and
                no special session manager.
              </P>
            </SubSection>
            ...
            <SubSection title="What You Should Not Ignore">
              ...
              />
              <P>
                If you violate those, the workflow quickly degrades back into ordinary multi-agent
                chaos.
              </P>
            </SubSection>
          </GuideSection>
          ...
          <GuideSection id="getting-started" number="12" title="Getting Started">
            ...
            <SubSection title="When to Graduate to the Full Flywheel">
              <P>
                ...
                <a
                  href="/complete-guide"
                  className="text-[#FF5500] hover:text-[#FFBD2E] transition-colors font-medium underline decoration-[#FF5500]/30 underline-offset-4 hover:decoration-[#FFBD2E]/50"
                >
                  full guide
                </a>{" "}
              ...
              />
              <P>
                At that point, the bigger document stops feeling like overhead and starts feeling
                like leverage.
              </P>
            </SubSection>
          </GuideSection>
    ...
    <section className="relative overflow-hidden pt-28 pb-24 md:pt-44 md:pb-36 bg-[#020408] border-b border-white/[0.04]">
      ...
      <div className="relative mx-auto text-center px-6 z-10 max-w-5xl">
        ...
        <p className="mx-auto mt-8 sm:mt-10 max-w-2xl sm:max-w-3xl text-lg sm:text-xl md:text-2xl text-zinc-400 leading-relaxed font-light">
          Three tools. One loop. Most of the value. Learn the beginner-friendly core of the Agentic
          Coding Flywheel: <Hl>Agent Mail</Hl> for coordination, <Hl>br</Hl> for task structure, and{" "}
          <Hl>bv</Hl> for intelligent routing.
        </p>
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full gap-5 p-6 sm:p-8">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-white tracking-tight mt-1">{name}</h3>
        </div>
        ...
        <div className="pt-5 border-t border-white/[0.04] space-y-3">
          <div>
            <span className="text-[0.6rem] font-bold text-white/30 uppercase tracking-[0.15em] block mb-1.5">
              Usage
            </span>
    ...
    <section className="relative overflow-hidden rounded-[3rem] border border-[#FF5500]/20 bg-[#0A0D14] py-24 md:py-32 my-32 shadow-[0_50px_100px_-20px_rgba(255,85,0,0.15)] group">
      ...
      <div className="relative mx-auto text-center px-6 z-10">
        ...
        <p className="mx-auto mt-8 max-w-2xl text-base sm:text-lg text-zinc-400 leading-relaxed font-light">
          Once the core loop feels natural, the full methodology adds richer planning workflows,
          memory systems, prompt libraries, and the complete Agent Flywheel stack.
        </p>
