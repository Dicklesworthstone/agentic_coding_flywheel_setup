...
import { AlertCircle, ChevronLeft, ChevronRight, Home, Terminal } from "lucide-react";
...
export default function WizardLayout({ children }: { children: React.ReactNode }) {
  ...
  const prevStepId = currentStep === 3 && userOS === "linux" ? 1 : currentStep - 1;
  ...
  const handleStepClick = useCallback(
    (stepId: number) => {
      ...
      const reachableSteps = isImmediateNext ? [...completedSteps, currentStep] : completedSteps;
