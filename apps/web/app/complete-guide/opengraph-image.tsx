  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", maxWidth: 640 }}>
        ...
        >
          Master the recursive system for operating AI agent swarms from human intent to flawless
          execution.
        </p>
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            />
            <span style={{ color: "#cbd5e1", fontSize: 20, fontWeight: 500, display: "flex" }}>
              {COMPLETE_GUIDE_PROMPT_COUNT} Copyable Prompts
            </span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div
            ...
            />
            <span style={{ color: "#cbd5e1", fontSize: 20, fontWeight: 500, display: "flex" }}>
              {VALIDATION_GATES.length} Validation Gates
            </span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div
            ...
            />
            <span style={{ color: "#cbd5e1", fontSize: 20, fontWeight: 500, display: "flex" }}>
              {COMPLETE_GUIDE_PHASE_COUNT} Phases
            </span>
          </div>
        </div>
      </div>
