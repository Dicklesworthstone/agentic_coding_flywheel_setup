...
export function CaamLesson() {
  return (
    <div className="space-y-8">
      <GoalBanner>
        Manage multiple AI provider accounts and automatically rotate when rate limits hit to keep
        your agents running continuously.
      </GoalBanner>

      {/* Section 1: What Is CAAM */}
      <Section title="What Is CAAM?" icon={<Users className="h-5 w-5" />} delay={0.1}>
        <Paragraph>
          <Highlight>CAAM (Coding Agent Account Manager)</Highlight> manages multiple API accounts
          across AI providers (Anthropic, OpenAI, Google) and automatically switches between them
          when rate limits hit. Instead of waiting for cooldowns, your agents keep working on the
      ...
      <Section title="Quick Start" icon={<Key className="h-5 w-5" />} delay={0.15}>
        <Paragraph>Register your accounts, then let CAAM handle switching.</Paragraph>
...
caam status`}
        ...
        <TipBox variant="warning">
          API keys are stored encrypted on disk. Never commit the CAAM config directory to version
          control.
        </TipBox>
      </Section>
      ...
      <Section title="Essential Commands" icon={<Terminal className="h-5 w-5" />} delay={0.2}>
        ...
        <TipBox variant="tip">
          Use <code>caam rotate</code> in your agent startup scripts. It picks the account with the
          lowest recent usage and longest time since last rate limit.
        </TipBox>
      </Section>
...
caam rotate  # → switches to "personal"`}
        ...
        <TipBox variant="info">
          CAAM&apos;s rotation algorithm weighs three factors: cooldown TTL remaining, tokens used
          in the last 24 hours, and time since the account was last rate-limited. This prevents
          hot-spotting on a single account.
        </TipBox>
      </Section>
...
caam budget --daily 100 --provider anthropic`}
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          ...
          <div className="p-3 rounded-lg bg-violet-500/10 border border-violet-500/30">
            ...
            <p className="text-white/80 text-sm mt-1">
              Track per-account costs alongside usage metrics
            </p>
          </div>
          <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
            <span className="text-emerald-400 font-semibold">CAAM + SLB</span>
            <p className="text-white/80 text-sm mt-1">
              Require approval before switching to expensive accounts
            </p>
          </div>
          <div className="p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
            <span className="text-amber-400 font-semibold">CAAM + ASB</span>
            <p className="text-white/80 text-sm mt-1">
              Back up account configs across machines with ASB
            </p>
          </div>
        </div>
      </Section>
  ...
  for (let i = 0; i < length; i++) {
    result.push(
      Math.max(
        ...
        Math.min(
          100,
          base + (i % 3 === 0 ? variance : i % 3 === 1 ? -variance * 0.6 : variance * 0.3),
        ),
      ),
    );
  }
...
const SCENARIOS: Scenario[] = [
  {
    ...
    color: "emerald",
    description:
      "All accounts healthy. Active account handling requests at moderate load. Rate limits well within safe range.",
    accounts: [
      {
        id: "a1",
        name: "work-primary",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(30, 8, 12),
      },
      {
        id: "a2",
        name: "work-backup",
        ...
        status: "standby",
        cooldownSec: 0,
        sparkline: makeSparkline(8, 3, 12),
      },
      {
        id: "o1",
        name: "openai-main",
        ...
        status: "standby",
        cooldownSec: 0,
        sparkline: makeSparkline(15, 5, 12),
      },
      {
        id: "g1",
        name: "gemini-pro",
        ...
        status: "standby",
        cooldownSec: 0,
        sparkline: makeSparkline(3, 2, 12),
      },
    ],
    activeAccountId: "a1",
    terminalLines: [
  ...
  },
  {
    ...
    color: "amber",
    description:
      "Primary account approaching rate limit. CAAM detects 87% usage and pre-selects the next account for rotation.",
    accounts: [
      {
        id: "a1",
        name: "work-primary",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(75, 12, 12),
      },
      {
        id: "a2",
        name: "work-backup",
      ...
      },
      {
        ...
        status: "standby",
        cooldownSec: 0,
        sparkline: makeSparkline(20, 6, 12),
      },
      {
        id: "g1",
        name: "gemini-pro",
        ...
        status: "standby",
        cooldownSec: 0,
        sparkline: makeSparkline(5, 2, 12),
      },
    ],
    activeAccountId: "a1",
    terminalLines: [
  ...
  },
  {
    ...
    color: "blue",
    description:
      "Rate limit hit! CAAM instantly rotates to work-backup in 47ms. No agent downtime. The depleted account enters cooldown.",
    accounts: [
      {
        id: "a1",
        name: "work-primary",
        ...
        status: "cooldown",
        cooldownSec: 300,
        sparkline: makeSparkline(90, 10, 12),
      },
      {
        id: "a2",
        name: "work-backup",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(10, 4, 12),
      },
      {
        id: "o1",
        name: "openai-main",
  ...
  },
  {
    ...
    color: "violet",
    description:
      "Primary account cooling down with 3:42 remaining. Backup account handling all traffic. Usage rising steadily on backup.",
    accounts: [
      {
        id: "a1",
        name: "work-primary",
        ...
        status: "cooldown",
        cooldownSec: 222,
        sparkline: makeSparkline(95, 5, 12),
      },
      {
        id: "a2",
        name: "work-backup",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(35, 10, 12),
      },
      {
        id: "o1",
        name: "openai-main",
  ...
  },
  {
    ...
    color: "sky",
    description:
      "High-throughput swarm mode: CAAM balances load across all providers. Each account stays below 60% to avoid rate limits entirely.",
    accounts: [
      {
        id: "a1",
        name: "work-primary",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(40, 8, 12),
      },
      {
        id: "a2",
        name: "work-backup",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(35, 7, 12),
      },
      {
        id: "o1",
        name: "openai-main",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(50, 10, 12),
      },
      {
        id: "g1",
        name: "gemini-pro",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(28, 6, 12),
      },
    ],
    activeAccountId: "a1",
    terminalLines: [
  ...
  },
  {
    ...
    color: "red",
    description:
      "Anthropic API outage! Both accounts unreachable. CAAM emergency failover: all traffic rerouted to OpenAI and Google in 82ms.",
    accounts: [
      {
        id: "a1",
        name: "work-primary",
      ...
      },
      {
        ...
        status: "cooldown",
        cooldownSec: 999,
        sparkline: makeSparkline(92, 5, 12),
      },
      {
        id: "o1",
        name: "openai-main",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(55, 12, 12),
      },
      {
        id: "g1",
        name: "gemini-pro",
        ...
        status: "active",
        cooldownSec: 0,
        sparkline: makeSparkline(42, 10, 12),
      },
    ],
    activeAccountId: "o1",
    terminalLines: [
      ...
      "",
      "$ caam next codex --usage-aware",
      "  Rerouting agent-1 → openai-main (38ms)",
      "$ caam next gemini --usage-aware",
...
function RotationArrow({
  ...
  return (
    ...
    >
      ...
      {switchMs > 0 && (
        <span className="text-[10px] font-mono text-blue-300 ml-1">{switchMs}ms</span>
      )}
    </motion.div>
  );
}
...
function AccountCard({
  account,
  isActiveScenarioAccount,
  active,
}: {
  account: Account;
  isActiveScenarioAccount: boolean;
  active: boolean;
}) {
  ...
  return (
    <motion.div
      layout
      animate={account.status === "cooldown" ? { x: [0, -3, 3, -3, 3, 0] } : { x: 0 }}
      transition={account.status === "cooldown" ? { duration: 0.4, ease: "easeInOut" } : SPRING}
    ...
    >
      ...
      {account.status === "active" && isActiveScenarioAccount && (
        <motion.div
          ...
          animate={
            active ? { opacity: [0.3, 0.7, 0.3], scale: [1, 1.01, 1] } : { opacity: 0.3, scale: 1 }
          }
          transition={
      ...
      <div className="flex items-start justify-between gap-1 mb-1.5">
        <div className="min-w-0 flex-1">
          ...
          <span
            className={`inline-block mt-0.5 rounded-full border px-1.5 py-0 text-[10px] font-medium ${getProviderBadgeColor(account.providerColor)}`}
          >
            {account.provider}
          </span>
        </div>
      ...
      <div className="mt-2 flex items-center justify-between">
        ...
        <span className="text-[10px] font-mono text-white/30">
          {formatTokens(account.tokensSent)}
        </span>
      </div>
            ...
            <div key={acc.id}>
              <div className="flex justify-between text-[10px] mb-0.5">
                ...
                <span className="text-violet-300 font-mono">
                  {Math.floor(acc.cooldownSec / 60)}:
                  {(acc.cooldownSec % 60).toString().padStart(2, "0")}
                </span>
              </div>
      ...
      <div className="space-y-2">
        {providers.map((provider) => {
          ...
          const avgUsage = Math.round(
            provAccounts.reduce((s, a) => s + a.usagePct, 0) / provAccounts.length,
          );
          const totalTokens = provAccounts.reduce((s, a) => s + a.tokensSent, 0);
          const color = providerColors[provider];
          const barColor =
            avgUsage >= 90 ? "bg-red-500" : avgUsage >= 70 ? "bg-amber-500" : "bg-emerald-500";
    ...
    function tick(now: number) {
      ...
      const interpolated = targetAccounts.map((target, i) => {
        ...
        return {
          ...
          rateLimitPct: Math.round(
            start.rateLimitPct + (target.rateLimitPct - start.rateLimitPct) * ease,
          ),
          tokensSent: Math.round(start.tokensSent + (target.tokensSent - start.tokensSent) * ease),
          cooldownSec: Math.round(
            start.cooldownSec + (target.cooldownSec - start.cooldownSec) * ease,
          ),
        };
      });
      ...
      <div className="relative p-6 sm:p-8 space-y-5">
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-white/50">
            Step through scenarios to see how CAAM manages accounts, rate limits, and emergency
            failover
          </p>
        </div>
          ...
          {SCENARIOS.map((s, i) => (
            <motion.div
              ...
              animate={{
                ...
                backgroundColor:
                  scenarioIdx === i
                    ? COLOR_MAP[s.color]?.text === "text-red-300"
                      ? "#ef4444"
                      : "#3b82f6"
        ...
        <AnimatePresence>
          {scenario.rotationEvent && (
            <RotationArrow
              fromName={rotFromName}
              toName={rotToName}
              switchMs={scenario.switchTimeMs}
            />
          )}
        </AnimatePresence>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-[10px] text-white/40">
          ...
          <div className="flex items-center gap-1">
            ...
            <span>
              Total tokens: {formatTokens(animatedAccounts.reduce((s, a) => s + a.tokensSent, 0))}
            </span>
          </div>
        </div>
      </div>
