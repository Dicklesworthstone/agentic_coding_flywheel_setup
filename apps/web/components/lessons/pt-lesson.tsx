...
export function PtLesson() {
  return (
    <div className="space-y-8">
      <GoalBanner>Master intelligent process management with Process Triage.</GoalBanner>

      {/* Section 1: What Is PT */}
      <Section title="What Is Process Triage?" icon={<Activity className="h-5 w-5" />} delay={0.1}>
        <Paragraph>
          <Highlight>PT (Process Triage)</Highlight> identifies and terminates abandoned or zombie
          processes using a Bayesian-inspired scoring algorithm. It evaluates process type, age,
          orphan status, and resource usage to calculate abandonment probability.
        </Paragraph>
        <Paragraph>
      ...
      <Section
        title="Try It: Process Triage Dashboard"
      ...
      <Section title="Essential Commands" icon={<Terminal className="h-5 w-5" />} delay={0.2}>
        <CommandList
          commands={[
            ...
            {
              command: "pt run",
              description: "Interactive triage: scan, infer, plan, approve, apply",
            },
        ...
        <TipBox>
          PT is useful when agents need to diagnose why builds are slow or what&apos;s consuming
          resources.
        </TipBox>
      </Section>
      ...
      <Section title="Common Scenarios" icon={<Play className="h-5 w-5" />} delay={0.3}>
        <CodeBlock
          code={`# Quick scan: what's using CPU, memory, and I/O
pt scan
...
const SCENARIOS: Scenario[] = [
    ...
    processes: [
      {
        ...
        dangerScore: 0.01,
        verdict: "safe",
        reason: "System init process. Protected.",
      },
      {
        pid: 1842,
        ppid: 1,
        ...
        dangerScore: 0.1,
        verdict: "safe",
        reason: "Active dev server with recent file watch activity.",
      },
      {
        pid: 2201,
        ppid: 1,
        ...
        dangerScore: 0.05,
        verdict: "safe",
        reason: "Database service. Active connections detected.",
      },
      {
        pid: 3384,
        ppid: 1842,
        ...
        dangerScore: 0.08,
        verdict: "safe",
        reason: "AI agent actively processing. IPC heartbeat OK.",
      },
      {
        pid: 4100,
        ppid: 1,
        ...
        dangerScore: 0.02,
        verdict: "safe",
        reason: "SSH daemon. System service.",
      },
      {
        pid: 5500,
        ppid: 1842,
        ...
        dangerScore: 0.06,
        verdict: "safe",
        reason: "Language server supporting IDE. Child of dev server.",
      },
    ],
    resources: {
      cpuCores: 8,
  ...
  },
  {
    ...
    processes: [
      ...
      },
      {
        ...
        verdict: "kill",
        reason:
          "Runaway build. 3h47m runtime (expected <20min). All cores saturated. System unresponsive.",
      },
      {
        pid: 6605,
        ppid: 6601,
        name: "rustc (proc-macro)",
        cpu: 47.1,
        memory: 2400,
        ioRead: 12.0,
        ioWrite: 55.0,
        ...
        dangerScore: 0.88,
        verdict: "kill",
        reason: "Child of runaway cargo. Proc-macro expansion stuck in loop.",
      },
      {
        pid: 6608,
        ppid: 6601,
        ...
        dangerScore: 0.85,
        verdict: "kill",
        reason: "Linker thrashing. Writing heavily to swap.",
      },
      {
        pid: 1842,
        ppid: 1,
        ...
        dangerScore: 0.12,
        verdict: "safe",
        reason: "Dev server starved but alive. Will recover after kill.",
      },
      {
        pid: 3384,
        ppid: 1842,
        ...
        dangerScore: 0.15,
        verdict: "safe",
        reason: "Agent waiting on I/O. Will resume after load drops.",
      },
    ],
    resources: {
      cpuCores: 8,
  ...
  },
  {
    ...
    processes: [
      ...
      },
      {
        ...
        verdict: "suspicious",
        reason:
          "Memory grew from 280M to 4.3G over 18h. Growth rate: ~120MB/hr. Classic leak pattern.",
      },
      {
        pid: 2950,
        ppid: 2900,
        ...
        dangerScore: 0.65,
        verdict: "suspicious",
        reason: "Worker thread inheriting leak. Shared heap.",
      },
      {
        pid: 2951,
        ppid: 2900,
      ...
      },
      {
        ...
        dangerScore: 0.08,
        verdict: "safe",
        reason: "Stable memory footprint. Normal dev server.",
      },
      {
        pid: 2201,
        ppid: 1,
        ...
        dangerScore: 0.05,
        verdict: "safe",
        reason: "Database under higher load from leaky app queries.",
      },
    ],
    resources: {
      cpuCores: 8,
    ...
    processes: [
      {
        ...
        dangerScore: 0.82,
        verdict: "kill",
        reason: "Crashed deploy script still holding zombie children. Kill to reap.",
      },
      {
        pid: 7001,
        ppid: 7000,
        ...
        dangerScore: 0.95,
        verdict: "kill",
        reason: "Zombie. Parent 7000 not calling wait(). Kill parent to reap.",
      },
      {
        pid: 7002,
        ppid: 7000,
        name: "python3 <defunct>",
        cpu: 0.0,
        memory: 0,
        ioRead: 0,
        ioWrite: 0,
        ...
        dangerScore: 0.95,
        verdict: "kill",
        reason: "Zombie. Cannot be killed directly, must reap via parent.",
      },
      {
        pid: 7003,
        ppid: 7000,
        ...
        dangerScore: 0.95,
        verdict: "kill",
        reason: "Zombie. Slot wasted in process table.",
      },
      {
        pid: 5519,
        ppid: 1,
        ...
        dangerScore: 0.88,
        verdict: "kill",
        reason: "Orphaned sleep. No session. Leftover from terminated script.",
      },
      {
        pid: 5520,
        ppid: 1,
        ...
        dangerScore: 0.86,
        verdict: "kill",
        reason: "Orphaned tail. Reparented to init. No useful work.",
      },
    ],
    resources: {
      cpuCores: 8,
    ...
    processes: [
      {
        ...
        dangerScore: 0.7,
        verdict: "suspicious",
        reason: "Massive I/O transfer saturating disk. Consider ionice or rescheduling.",
      },
      {
        pid: 8200,
        ppid: 1,
      ...
      },
      {
        ...
        dangerScore: 0.15,
        verdict: "safe",
        reason: "Blocked on I/O. Will resume when disk pressure drops.",
      },
      {
        pid: 2201,
        ppid: 1,
        ...
        dangerScore: 0.35,
        verdict: "safe",
        reason: "WAL writes delayed. May cause query timeouts but is self-recovering.",
      },
      {
        pid: 8300,
        ppid: 8200,
        ...
        dangerScore: 0.5,
        verdict: "suspicious",
        reason: "Decompression using all cores, feeding disk write pipeline.",
      },
      {
        pid: 3384,
        ppid: 1842,
        ...
        dangerScore: 0.1,
        verdict: "safe",
        reason: "Agent idle, waiting for dev server response.",
      },
    ],
    resources: {
      cpuCores: 8,
  ...
  },
  {
    ...
    description:
      "Practice the full triage workflow: identify, score, confirm, and kill problematic processes.",
    terminalLines: [
      "$ pt",
    ...
    processes: [
      {
        ...
        dangerScore: 0.1,
        verdict: "safe",
        reason: "Active dev server. Recently accessed filesystem.",
      },
      {
        pid: 7720,
        ppid: 1,
        ...
        dangerScore: 0.82,
        verdict: "kill",
        reason: "Running 47 minutes (expected <5min). Likely hung on network or lock.",
      },
      {
        pid: 9471,
        ppid: 1,
        ...
        dangerScore: 0.95,
        verdict: "kill",
        reason: "Zombie process. Parent exited without wait(). Wasting PID slot.",
      },
      {
        pid: 3384,
        ppid: 1842,
        ...
        dangerScore: 0.08,
        verdict: "safe",
        reason: "Actively processing. IPC heartbeat every 2s. High CPU expected.",
      },
      {
        pid: 5519,
        ppid: 1,
        ...
        dangerScore: 0.88,
        verdict: "kill",
        reason: "Orphaned sleep. No parent, no session. Leftover garbage.",
      },
      {
        pid: 2201,
        ppid: 1,
        ...
        dangerScore: 0.05,
        verdict: "safe",
        reason: "Protected system service. Active connections.",
      },
    ],
    resources: {
      cpuCores: 8,
    ...
    <div className="flex flex-col items-center gap-1.5">
      <div className="relative w-20 h-20">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-xs font-mono font-bold text-white/80 mt-0.5">
            {pct.toFixed(0)}%
          </span>
        </div>
      </div>
      <div className="text-center">
        ...
        <div className="text-[10px] font-mono text-white/30">
          {formatMem(value)}/{formatMem(max)} {unit}
        </div>
      </div>
    </div>
  );
      ...
      {roots.map((root) => (
        <div key={root.pid}>
          <div className="flex items-center gap-2">
            <span className={`font-bold ${getStateColor(root.state)}`}>
              {getStateLabel(root.state)}
            </span>
          ...
          {children(root.pid).map((child, ci) => {
            ...
            return (
              ...
              >
                ...
                <span className={`font-bold ${getStateColor(child.state)}`}>
                  {getStateLabel(child.state)}
                </span>
              ...
              line.startsWith("$")
                ...
                : line.includes("!!") || line.includes("WARNING")
                  ...
                  : line.includes("Recommendation")
                    ? "text-amber-300"
                    : line.includes("terminated") || line.includes("nominal")
                      ? "text-emerald-400"
                      : "text-white/50"
            }`}
          >
        ...
        {proc.state === "zombie" && (
          <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-2.5 mb-4 flex items-start gap-2">
            ...
            <p className="text-xs text-amber-300/80 leading-relaxed">
              Zombie processes cannot be killed directly. PT will signal the parent process (PID{" "}
              {proc.ppid}) instead.
            </p>
          </div>
        )}
...
function InteractiveProcessTriageDashboard() {
  ...
  const suspiciousPids = scenario.processes
    .filter((p) => p.verdict === "suspicious")
    .map((p) => p.pid);
  ...
  return (
    ...
    >
      ...
      <div className="relative p-5 sm:p-8 space-y-5">
        {/* Header */}
        <div className="text-center">
          <p className="text-sm font-semibold text-white/80">Process Triage Dashboard</p>
                    ...
                    <div className="text-center space-y-1 mt-1">
                      ...
                      <div className="flex gap-3 text-[10px] font-mono">
                        <span className="text-emerald-400">
                          {"\u2191"}
                          {formatIO(res.diskRead)} MB/s
                        </span>
                        <span className="text-amber-400">
                          {"\u2193"}
                          {formatIO(res.diskWrite)} MB/s
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div key={proc.pid}>
                      ...
                      >
                        <div className="grid grid-cols-[44px_36px_1fr_52px_52px_44px_64px] gap-1.5 items-center">
                          ...
                          <span
                            className={`font-mono text-[10px] font-bold ${getStateColor(proc.state)}`}
                          >
                            {getStateLabel(proc.state)}
                          </span>
                          <div className="flex items-center gap-1.5 min-w-0">
                            <span
                              className={`text-xs truncate ${isKilled ? "line-through text-white/20" : "text-white/70"}`}
                            >
                              {proc.name}
                            </span>
                            {isKilled && (
                          ...
                          <div className="text-right">
                            <span
                              className={`font-mono text-[10px] ${highCpu ? "text-red-400" : "text-white/40"}`}
                            >
                              {proc.cpu.toFixed(1)}
                            </span>
                            <UsageBar
                              value={proc.cpu}
                              max={100}
                              color={highCpu ? "bg-red-500" : "bg-blue-500"}
                              pulse={highCpu && !isKilled}
                            />
                          </div>
                          {/* Memory */}
                          <div className="text-right">
                            <span
                              className={`font-mono text-[10px] ${highMem ? "text-amber-400" : "text-white/40"}`}
                            >
                            ...
                            <UsageBar
                              value={proc.memory}
                              max={8192}
                              color={highMem ? "bg-amber-500" : "bg-indigo-500"}
                            />
                          </div>
                          {/* I/O */}
                          <span className="text-right font-mono text-[10px] text-white/30">
                            {proc.ioRead + proc.ioWrite > 0
                              ? `${formatIO(proc.ioRead + proc.ioWrite)}`
                              : "-"}
                          </span>
                          {/* Danger score */}
                          <div className="flex items-center gap-1">
                            ...
                            <span
                              className={`text-[10px] font-mono w-5 text-right ${isScored ? getDangerTextColor(proc.dangerScore) : "text-white/15"}`}
                            >
                      ...
                      <AnimatePresence>
                        {isSelected && isScored && !isKilled && (
                          ...
                          >
                            <div
                              className={`mx-3 mb-3 rounded-xl border p-4 ${
                                proc.verdict === "kill"
                                  ? "border-red-500/20 bg-red-500/[0.04]"
                                  : proc.verdict === "suspicious"
                            ...
                            >
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[10px] text-white/20 ml-auto font-mono">
                                  Score: {(proc.dangerScore * 100).toFixed(0)} | Uptime:{" "}
                                  {proc.uptime} | PPID: {proc.ppid}
                                </span>
                              </div>
                              ...
                              <div className="grid grid-cols-4 gap-3 mb-3">
                                ...
                                <div className="text-center">
                                  <div className="text-[10px] text-white/25 uppercase">
                                    I/O Read
                                  </div>
                                  <div className="text-xs font-mono text-white/60">
                                    {formatIO(proc.ioRead)} MB/s
                                  </div>
                                </div>
                                <div className="text-center">
                                  <div className="text-[10px] text-white/25 uppercase">
