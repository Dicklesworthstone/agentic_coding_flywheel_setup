...
import { AlertOctagon, BrainCircuit, CheckCircle2, FileCode2, ScrollText } from "lucide-react";
...
export function ContextHorizonViz() {
  ...
  return (
    <div
      ref={ref}
      className="my-10 rounded-2xl border border-white/[0.08] bg-[#0a0a0c] shadow-2xl glass-subtle overflow-hidden flex flex-col"
    >
      {/* HEADER */}
      ...
      <div className="relative w-full h-[450px] bg-[#020408] flex items-end justify-center gap-12 sm:gap-32 p-8 overflow-hidden">
        ...
        <div className="relative flex flex-col items-center justify-end h-full z-10 w-28 sm:w-40">
          <motion.div
            ...
            transition={
              rm ? { duration: 0 } : { type: "spring", stiffness: 150, damping: 20, mass: 0.8 }
            }
          >
          ...
          <div className="mt-5 text-center">
            <div className="text-xs sm:text-sm font-black text-white tracking-widest uppercase">
              Plan Space
            </div>
          ...
          >
            <div
              className={cn(
                ...
                isCodeBlowingHorizon
                  ? "bg-gradient-to-r from-transparent via-[#FF5F56] to-transparent"
                  : "bg-gradient-to-r from-transparent via-[#FF5500] to-transparent",
              )}
            />
            ...
            <FileCode2
              className={cn(
                ...
                isCodeBlowingHorizon
                  ? "text-[#FF5F56] drop-shadow-[0_0_10px_rgba(255,95,86,0.5)]"
                  : "text-[#FF5500] drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]",
              )}
            />
          </motion.div>
          ...
          <div className="mt-5 text-center">
            ...
            <div
              className={cn(
                ...
                isCodeBlowingHorizon
                  ? "text-[#FF5F56] bg-[#FF5F56]/10 border-[#FF5F56]/20"
                  : "text-[#FF5500] bg-[#FF5500]/10 border-[#FF5500]/20",
              )}
            >
              {isCodeBlowingHorizon ? (
                <>
